  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.lg, gap: spacing.lg }}>
        ...
        {/* "Instalar VALU", "Privacidad y datos" y "Perfil" (con el
            correo de recuperación) viven ahora en el menú de cuenta
            (arriba, en cualquier pantalla) — spec: "para que ajustes no
            se vean tan cargado". */}
      </ScrollView>
    </SafeAreaView>
  );
